...
function checkId(){
	...
	if(id == "") 
		document.getElementById("idDiv").innerText = "먼저 아이디를 입력해주세요";
	else {
		window.open("http://localhost:8080/memberServlet/CheckIdServlet?id="+id,"","width=300 height=100 top=200 left=700");
	}
}
